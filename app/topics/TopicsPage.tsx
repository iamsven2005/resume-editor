...
const TopicsPage = () => {
  ...
  const totalMembers = mockTopics.reduce((sum, topic) => sum + topic.memberCount, 0);
              ...
              <Card className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-foreground">{mockTopics.length}</p>
                  </div>
                </div>
              </Card>
            ...
            <div className="space-y-4">
              ...
              {filteredTopics.length === 0 && (
                <Card className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">Try adjusting your search terms or explore our popular communities.</p>
                </Card>
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {(topic.memberCount / 1000).toFixed(0)}k
                      </span>
                    </div>
                  </Link>
                ))}
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Welcome to our Reddit-like platform! Discover communities, share your thoughts, 
                and engage in meaningful discussions with people who share your interests.
              </p>
            </Card>
          </div>
        </div>
